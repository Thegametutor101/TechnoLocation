...
Public Class UCRent
    ...
    Private Sub gridAllEquipment_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub gridSelectedEquipment_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs)
        For Each row As DataGridViewRow In gridAllEquipment.Rows
            If row.Cells(0).Value = gridSelectedEquipment.CurrentRow.Cells(0).Value Then
                row.Cells(4).Value = 1
            End If
        Next
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click
        ...
        If gridSelectedEquipment.Rows.Count < 0 Then
            complete = False
